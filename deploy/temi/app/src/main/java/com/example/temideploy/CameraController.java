...
public class CameraController {
    ...
    public void openCamera() {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            Log.d("CAMERR","no permissions");
            return;
        }
        startBackgroundThread();
        Log.d("CAM","verified permissions");
        setUpCameraOutputs();
        ...
        try {
            ...
            Log.d("CAM","about to start background thread");
            Log.d("CAM","handler is " + backgroundHandler);
    ...
    private void setUpCameraOutputs() {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                //Log.d("SIZES", String.valueOf(Arrays.asList(map.getOutputSizes(ImageFormat.JPEG))));
    ...
    public String takePicture() {
        ...
        try {
            if (null == mCameraDevice) {
                Log.d("CAMERR","camera device is null");
                return null;
            }
    ...
    private File getOutputMediaFile() {
        ...
        File mediaFile;
        mediaFile = new File(mediaStorageDir.getPath() + File.separator + "IMG_ARUCO.jpg");
