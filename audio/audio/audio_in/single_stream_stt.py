...
class SingleStreamSTT:
	...
	def run_terminal(self, receival_callback, send_in_progress_text_callback, receive_agent_highlight, activation_time, content_id, stream_lock):
		...
		if stream_lock.acquire(blocking=False):
			...
			receive_agent_highlight(content_id)
